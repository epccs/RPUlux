...
//At start of each night clear the charge accumulator then 
// load the LED control settings from EEPROM and operate them.
void callback_for_night_attach(void)
{
    ...
    // If solar power is used a test is needed to see if the battery got charged
    if (1) 
    {
...
//At start of each day ... return from a safe landing
